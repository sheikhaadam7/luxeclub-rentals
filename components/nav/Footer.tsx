      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10">
          ...
          <div className="space-y-3">
            ...
            <nav className="flex flex-col gap-2">
              <Link href="/rent-suv-in-dubai" className="text-sm text-white/60 hover:text-white transition-colors duration-300">Luxury SUVs</Link>
          ...
          <div className="space-y-3">
            ...
            <nav className="flex flex-col gap-2">
              ...
              <Link href="/rent-suv-in-dubai" className="text-sm text-white/60 hover:text-white transition-colors duration-300">Luxury SUV Rental</Link>
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <a
                href="https://www.instagram.com/luxeclubrentals/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LuxeClub Rentals on Instagram"
