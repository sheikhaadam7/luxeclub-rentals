...
import { cancelGuestBooking } from '@/app/actions/guest-bookings'
import { useCurrency } from '@/lib/currency/context'

interface GuestCancelButtonProps {
  bookingId: string
  guestEmail: string
  dailyRate: number
  totalDue: number
...
export default function GuestCancelButton({
  ...
  async function handleConfirmCancel() {
    ...
    const result = await cancelGuestBooking(bookingId, guestEmail)
