  ...
  return (
    <div className="group bg-brand-surface border border-brand-border rounded-2xl overflow-hidden card-hover hover:border-brand-border-hover">
      ...
      <div className="px-5 pb-5 flex gap-3">
        <Link
          href={`/book/${slug}`}
          className="flex-1 text-center py-2.5 rounded-xl bg-brand-cyan text-white text-sm font-semibold hover:bg-brand-cyan-hover shadow-[0_0_20px_rgba(0,135,90,0.15)] hover:shadow-[0_0_30px_rgba(0,135,90,0.25)] transition-all duration-300"
        >
          Book Now
        </Link>
        <a
