  ...
  return (
    <div className="group aspect-[3/4] bg-brand-surface overflow-hidden flex flex-col">
      ...
      <div className="flex border-t border-white/10">
        <Link
          href={`/book/${slug}`}
          className="flex-1 text-center py-5 sm:py-4 text-white/80 text-base sm:text-sm font-medium hover:text-white hover:bg-[#C9A96E]/50 hover:backdrop-blur-xl transition-all duration-300"
        >
          {t('catalogue.bookNow')}
        </Link>
        <a
          ...
          className="flex items-center justify-center gap-1.5 px-6 py-5 sm:py-4 border-l border-white/10 text-white/80 text-base sm:text-sm font-medium hover:text-white hover:bg-[#25D366]/30 hover:backdrop-blur-xl transition-all duration-300"
        >
