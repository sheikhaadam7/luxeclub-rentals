  ...
  // ── Brand pages ──────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        isFaq: true,
        content:
          "Our standard reservation fee is AED 495, paid at booking to secure the vehicle and deducted from your total on pickup day. A refundable damage deposit (typically AED 1,000–3,000 depending on the vehicle type) is held on your card at pickup for most of the fleet (AED 2,000–2,599 for Huracán / Urus / STO), or you can opt out of that entirely with our no-deposit surcharge of AED 200. The Revuelto has a higher deposit requirement given the AED 8,999/day value, and we'll walk you through the exact numbers when you book.",
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        isFaq: true,
        content:
          "Our standard reservation fee is AED 495, paid at booking and deducted from your total on pickup day. A refundable damage deposit (typically AED 1,000–3,000 depending on the vehicle type) is held on your card at pickup, or eligible drivers (aged 23+, with documentation in order) can opt for the no-deposit surcharge of AED 200 in lieu of the hold. The no-deposit option is popular across the Porsche fleet.",
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        isFaq: true,
        content:
          "The no-deposit option is reviewed per booking on exotic cars given the higher underlying vehicle value. For eligible drivers (aged 27+ on halo cars, 25+ on exotic supercars, with documentation in order and a clean driving history), we can usually structure a flat surcharge in lieu of the refundable damage hold. The surcharge amount is confirmed at booking rather than promised up front. See our [no-deposit luxury car rental page](/luxury-car-rental-no-deposit-dubai) for the full eligibility breakdown and the deposit-policy options across our fleet.",
      },
      {
