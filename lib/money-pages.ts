  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content:
          "Exotic rental pricing is different from the broader luxury market. The cars in this category are the rarest on the fleet, and pricing reflects both the vehicle value and the demand-concentration on specific dates (peak season, weekends, wedding months).\n\n**Daily rates** are the standard pricing for 1–3 day bookings, which is the most common exotic rental length. Most exotic rentals are specific-occasion bookings rather than week-long trips.\n\n**Weekly rates** save roughly 30–35% per day versus daily. Worth asking about if your trip is five days or more.\n\n**Monthly rates** save roughly 45–55% per day versus the daily headline — most common among relocated UHNW customers or long-stay visitors.\n\nIndicative exotic pricing across the fleet:\n\n**Lamborghini Huracán STO:** AED 4,000/day · AED 19,000/week · AED 60,000/month\n**McLaren 765LT:** AED 5,000/day · AED 23,750/week · AED 75,000/month\n**Ferrari SF90 Stradale:** AED 7,500/day · AED 35,650/week · AED 112,500/month\n**Rolls-Royce Dawn:** from AED 5,000/day (price on request)\n**Rolls-Royce Ghost:** from AED 5,000/day (price on request)\n**Ferrari Purosangue:** AED 11,000/day · AED 52,250/week · AED 165,000/month\n**Lamborghini Revuelto:** AED 12,000/day · AED 57,000/week · AED 180,000/month\n**Rolls-Royce Cullinan Mansory:** from AED 10,000/day (price on request)\n\nPrices are indicative and may shift during Dubai Shopping Festival, Formula 1 Abu Dhabi weekend, and the December 20 to January 10 peak window. For exact rates on your chosen dates, see the live vehicle grid below or contact us directly.",
      },
      {
      ...
      },
      {
        ...
        isFaq: true,
        content:
          "Exotic rental in Dubai starts at around AED 4,000/day for the Lamborghini Huracán STO and goes up to AED 12,000/day for the Lamborghini Revuelto. Most of the fleet sits between AED 5,000 and AED 11,000/day. Weekly rates save roughly 30–35% per day versus daily. Halo cars — Cullinan Mansory, Revuelto, SF90, Purosangue — are priced per booking during peak season (November to March) because demand concentrates on specific dates. For exact rates on your chosen dates, see the live vehicle grid or contact us directly via WhatsApp.",
      },
      {
