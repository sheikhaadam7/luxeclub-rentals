  ...
  // ── Brand pages ──────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        isFaq: true,
        content:
          "To secure your reservation, a AED 495 booking confirmation is taken at the time of booking. This guarantees your chosen vehicle today. It is fully deducted from your rental total when you collect the car — not an additional fee.\n\nShould your plans change, you can cancel any time up to 24 hours before your scheduled pickup and the AED 495 will be refunded in full to your original payment method.\n\nA refundable pre-authorisation hold is taken on your card at the time of collection — the amount depends on the car. AED 2,500 on most vehicles, AED 4,500 on Lamborghini, Ferrari, and McLaren models (the Urus and Portofino stay at AED 2,500), and AED 5,000 on our top-tier cars (Revuelto, Purosangue, SF90, GT3 RS, Cullinan Mansory). The exact hold amount is shown on each vehicle's page. Drivers under 23 always pay AED 5,000 regardless of the car. This is a security hold, not a charge — it is released back to your card after the vehicle is returned and inspected.\n\nA no-deposit option is also available on request. Let our team know when booking and we'll arrange it for you.",
      },
      {
