      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            ...
            <div className="lg:sticky lg:top-24 bg-white/[0.03] border border-white/[0.08] rounded-2xl p-7 space-y-6">
              ...
              {vehicle.daily_rate && (
                <p className="text-white">
                  ...
                  <span className="text-white/50 text-base ml-1.5">/Daily</span>
                </p>
              )}
              ...
              <div className="space-y-1.5">
                <p className="text-sm text-white/80">
                  <span className="mr-2">&#x2139;&#xFE0F;</span>Insurance included
                </p>
                <p className="text-sm text-white/80">
                  <span className="mr-2">&#x1F911;</span>Crypto is accepted
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                {vehicle.daily_rate && (
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-white/60">Included mileage limit:</span>
                    <span className="text-sm font-bold text-white">250 Km/Day</span>
                  </div>
                )}

                <div className="flex items-center justify-between">
                  <span className="text-sm text-white/60">Additional mileage charge:</span>
                ...
                {vehicle.weekly_rate && (
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-white/60">Weekly rate</span>
                    <PriceDisplay amount={vehicle.weekly_rate} className="text-sm font-bold text-white" />
                  </div>
                )}
                {vehicle.monthly_rate && (
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-white/60">Monthly rate</span>
              ...
              {vehicle.is_available ? (
                <Link
                  ...
                  className="block w-full text-center bg-brand-cyan text-white font-semibold py-3.5 rounded-xl hover:bg-brand-cyan-hover shadow-[0_0_20px_rgba(160,165,173,0.15)] hover:shadow-[0_0_30px_rgba(160,165,173,0.25)] transition-all duration-300"
                >
                  Book Now
                </Link>
              ) : (
        ...
        <div className="mt-12 space-y-4">
          ...
          <div className="bg-white/[0.03] border border-white/[0.08] rounded-xl p-6 space-y-4">
            {vehicle.daily_rate && (
              <div className="flex items-center justify-between">
                <span className="text-sm text-white/60">Security Deposit</span>
                <PriceDisplay amount={vehicle.daily_rate} className="text-sm font-bold text-green-400" />
              </div>
            )}
            <div className="flex items-center justify-between">
              <span className="text-sm text-white/60">Included Mileage</span>
              <span className="text-sm font-bold text-white">250 Km/Day</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm text-white/60">Additional Mileage Charge</span>
            ...
            <div className="flex items-center gap-2 text-sm text-white/60">
              <span>&#x2139;&#xFE0F;</span>
              <span>Insurance included with all rentals</span>
            </div>
          </div>
        </div>
