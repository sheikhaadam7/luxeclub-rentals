            ...
            <div className="lg:sticky lg:top-24 bg-white/[0.03] border border-white/[0.08] rounded-2xl p-7 space-y-6">
              ...
              {vehicle.is_available ? (
                <Link
                  ...
                  className="block w-full text-center bg-brand-cyan text-white font-semibold py-3.5 rounded-xl hover:bg-brand-cyan-hover shadow-[0_0_20px_rgba(0,135,90,0.15)] hover:shadow-[0_0_30px_rgba(0,135,90,0.25)] transition-all duration-300"
                >
                  Book Now
                </Link>
              ) : (
