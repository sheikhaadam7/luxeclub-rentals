          ...
          <aside className="w-full lg:w-[420px] flex-shrink-0">
            <div className="lg:sticky lg:top-24 bg-white/[0.03] border border-white/[0.08] p-7 space-y-6">
              ...
              <div className="flex gap-3">
                <a
                  href={callUrl}
                  className="flex-1 flex items-center justify-center gap-2 py-3.5 border border-white/[0.12] text-white text-sm font-semibold hover:bg-white/[0.06] transition-all duration-300"
                >
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                <a
                  ...
                  className="flex-[1.5] flex items-center justify-center gap-2 py-3.5 bg-[#25D366] text-white text-sm font-semibold hover:bg-[#20BD5A] transition-all duration-300"
                >
              ...
              {vehicle.is_available ? (
                <Link
                  ...
                  className="block w-full text-center bg-brand-cyan text-white font-semibold py-3.5 hover:bg-brand-cyan-hover shadow-[0_0_20px_rgba(201,169,110,0.15)] hover:shadow-[0_0_30px_rgba(201,169,110,0.25)] transition-all duration-300"
                >
                  <T k="vehicle.bookNow" />
                </Link>
              ) : (
