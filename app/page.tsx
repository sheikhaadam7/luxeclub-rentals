        ...
        <section className="relative border-t border-white/[0.06] overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto px-4 sm:px-6 py-24 text-center relative z-10 space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
              <Link
                href="/catalogue"
                className="px-10 py-4 rounded-xl bg-brand-cyan text-white text-base font-semibold hover:bg-brand-cyan-hover shadow-[0_0_20px_rgba(0,135,90,0.15)] hover:shadow-[0_0_30px_rgba(0,135,90,0.25)] transition-all duration-300"
              >
                Browse Fleet
              </Link>
              <Link
