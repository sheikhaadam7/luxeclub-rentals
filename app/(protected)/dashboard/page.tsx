  ...
  return (
    <main className="min-h-screen bg-luxury flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-6 px-4">
        ...
        <Link
          href="/bookings"
          className="flex items-center gap-3 bg-brand-surface border border-brand-border rounded-[--radius-card] px-6 py-4 hover:border-brand-cyan/30 transition-colors duration-200 group"
        >
          <div className="space-y-0.5">
            <p className="font-display text-base font-medium text-white group-hover:text-brand-cyan transition-colors">
              My Bookings
            ...
            <p className="text-xs text-brand-muted">
              View upcoming and past rental bookings
            </p>
          </div>
          <svg
            className="w-4 h-4 text-brand-cyan flex-shrink-0"
