...
import { requestDateModification } from '@/app/actions/bookings'

interface RequestDateChangeButtonProps {
  bookingId: string
...
export default function RequestDateChangeButton({
  bookingId,
  currentStartDate,
  currentEndDate,
  modificationStatus,
  ...
  async function handleSubmit() {
    ...
    const result = await requestDateModification(bookingId, newStart, newEnd)
