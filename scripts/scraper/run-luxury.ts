...
import { scrapeLuxurySupercars } from './scrape-luxury-supercars'
...
async function run() {
  ...
  try {
    console.log('=== Luxury Supercars Dubai Scraper ===')
    console.log('Scraping vehicles from luxurysupercarsdubai.com...')
    const vehicles = await scrapeLuxurySupercars(page)
